...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:taujob1111@gmail.com">taujob1111@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"><a href="tel:+263778456168"></i>+263 778 456 168</a></li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">TAU <span>HOTEL</span><p class="logo_w3l_agile_caption">The Eden On Earth</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="admin/index.php" target="_blank">Admin</a></li>
						</ul>
					</nav>
				</div>
			</nav>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">TAU HOTELS</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							<span class="cbp-ig-icon w3_cube"></span>
							<h4 class="cbp-ig-title">NATURE VIEW BALCONY</h4>
							<span class="cbp-ig-category">TAU HOTELS</span>
						</div>
					</li>
					<li>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HOTELS</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong><a href="tel:+263778456168">+263778456168</a></p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:taujob1111@gmail.com">TAUJOB1111@GMAIL.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 17TH CRESCENT, WARREN PARK 1, HARARE, ZIMBABWE</p>
...
<!-- /contact -->
			<div class="copy">
		        <p><?php echo date("Y");?>TAU HOTELS . All Rights Reserved | Design by <a href="index.php">TAU</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
